...
.. thumbnail:: /_images/Day2/2.AI/4.posenet/pose_example1.jpg
...
.. thumbnail:: /_images/Day2/2.AI/4.posenet/pose_estimation_camera.png
...
-   With the minor functions explanation, we have discussed many parameters that controls the overlay settings. Try to tweak the execution cell in your jupyter notebook to change how the results are overlayed.
    ...
    .. thumbnail:: /_images/Day2/2.AI/4.posenet/pose_example2.jpg

    |

    .. thumbnail:: /_images/Day2/2.AI/4.posenet/pose_example3.jpg

    |

    .. thumbnail:: /_images/Day2/2.AI/4.posenet/pose_example4.jpg