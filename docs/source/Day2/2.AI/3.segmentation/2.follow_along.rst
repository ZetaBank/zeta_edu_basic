...
.. thumbnail:: /_images/Day2/2.AI/segmentation.png
...
-   Pick one of the images with urban city scene and initialize the image/ output name. 
    ...
    .. thumbnail:: /_images/Day2/2.AI/city.jpg
...
-   Show the resulting image
    ...
    .. thumbnail:: /_images/Day2/2.AI/city_seg.jpg
...
-   Pick one of the images with outdoor scenes and initialize the image/ output name. 
    ...
    .. thumbnail:: /_images/Day2/2.AI/outdoor.jpg
...
-   Show the resulting image
    ...
    .. thumbnail:: /_images/Day2/2.AI/outdoor_seg.jpg
...
-   Pick one of the images with people and initialize the image/ output name. 
    ...
    .. thumbnail:: /_images/Day2/2.AI/people.jpg
...
-   Show the resulting image
    ...
    .. thumbnail:: /_images/Day2/2.AI/people_seg.jpg
...
-   Pick one of the images with variaty of objects and people and initialize the image/ output name. 
    ...
    .. thumbnail:: /_images/Day2/2.AI/object.jpg
...
-   Show the resulting image
    ...
    .. thumbnail:: /_images/Day2/2.AI/object_seg.jpg
...
-   Pick one of the images with urban city scene and initialize the image/ output name. 
    ...
    .. thumbnail:: /_images/Day2/2.AI/indoor.jpg
...
-   Show the resulting image
    ...
    .. thumbnail:: /_images/Day2/2.AI/indoor_seg.jpg
