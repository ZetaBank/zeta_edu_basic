...
- To add excitement and a competitive element, the game includes a time limit of 4 minutes per player.
...
-----------------------
    ...
    2. The robot can be moved with a joystick. The joystick operation method is as follows.

    3. Various trash such as bottles and cans are placed on the stage.

    4. The objective of the game is to control the robot and sort the trash in the designated area.
