Let's Get Used to the Robot Arm
================
...
.. thumbnail:: /_images/Day1/2.robot_arm/donky.png
...
- Place the doll where you want, pick it up with the robot arm and place it in your hand.
